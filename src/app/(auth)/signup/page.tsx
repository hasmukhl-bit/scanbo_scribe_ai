        ...
        <Left>
          <Stack spacing={3} sx={{ width: "100%", maxWidth: 500 }} component="form" onSubmit={handleSubmit}>
            ...
            <Stack spacing={2}>
              <Stack direction={{ xs: "column", sm: "row" }} spacing={1.3}>
                <InputField
                  ...
                  type="text"
                  value={fullName}
                  InputLabelProps={{ shrink: Boolean(fullName) }}
                  onChange={(event) => {
                ...
                <InputField
                  ...
                  helperText={fieldErrors.specialty || undefined}
                  required
                >
              ...
              <InputField
                ...
                InputLabelProps={{ shrink: Boolean(confirmPassword) }}
                onChange={(event) => {
            ...
            <Typography variant="body2" color="#64748b" textAlign="center" sx={{ mt: 0.6 }}>
              By signing up, you agree to the <AuthTextLink href="#">terms of Use</AuthTextLink>,{" "}
              <AuthTextLink href="#">Privacy Policy</AuthTextLink>.
            </Typography>

            <Typography variant="h6" color="#334155" textAlign="center" fontWeight={500} sx={{ mt: 0.2 }}>
              Already have an Account? <AuthTextLink href="/login">Login</AuthTextLink>
            </Typography>
          </Stack>
        </Left>
