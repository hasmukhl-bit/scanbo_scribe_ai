...
const RightCardContent = styled(Box)({
  height: "100%",
  display: "flex",
  alignItems: "center"
});

const RightInner = styled(Stack)({
  width: "100%",
  justifyContent: "center"
});
      ...
      <Background>
        <PageContainer maxWidth="lg">
          <TwoColumnGrid>
            ...
            <RightCard elevation={2}>
              <RightCardContent>
                <RightInner spacing={2.5}>
                  <Box>
                  ...
                  <Stack spacing={2} component="form">
                    <StyledTextField
                      label="Email"
                      placeholder="dr.jordan@clinic.com"
                      fullWidth
                      variant="outlined"
                  ...
                  <Button component={Link} href="/login-password" variant="text">
                    Back to login
                  </Button>
                </RightInner>
              </RightCardContent>
